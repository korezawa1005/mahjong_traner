...
牌効率_quiz_data = [
  ...
  {
    tiles: %w[三筒 四筒 赤五筒 五筒 五筒 七筒 二萬 二萬 四萬 四萬 四萬 五萬 六萬 六萬],
    correct: '七筒',
    dora: '六筒',
    situation: '東1局 東家 6巡目',
  ...
  {
    tiles: %w[五萬 五萬 六萬 七萬 二索 二索 三索 三索 四索 五筒 六筒 六筒 七筒 七筒],
    correct: '五萬',
    dora: '一萬',
    situation: '東1局 西家 7巡目',
  ...
  {
    tiles: %w[四萬 五萬 六萬 六萬 二筒 三筒 四筒 六筒 六筒 七筒 赤五索 六索 六索 七索],
    correct: '七筒',
    dora: '三索',
    situation: '東1局 西家 7巡目',
  ...
  {
    tiles: %w[四萬 五萬 七萬 七筒 二筒 三筒 六筒 七筒 八筒 八筒 八筒 二索 三索 四索],
    correct: '七萬',
    dora: '一筒',
    situation: '東1局 西家 7巡目',
    explanation: '受け入れ最大は打4mだが、ピンフ1シャンテンなので、7mか8sどちらを落とすか問題。瞬間の受け入れは同数でも、未完成ターツを縦に引いた際に差が出る。例として2pツモで見ると、7m切りは受け入れが7枚増えるのに対し、8s切りは4枚増に留まる。よって7m切りが3枚分有利。牌は繋がっている方を残すのがセオリー。',
    accept_tiles: {
    "四萬" => 19,
    "七萬" => 16,
    "八筒" => 16
  ...
  {
    tiles: %w[三萬 四萬 六筒 六筒 六筒 七筒 三索 三索 四索 五索 五索 七索 八索 八索],
    correct: '七筒',
    dora: '三萬',
    situation: '東1局 西家 7巡目',
    explanation: '受け入れは最大。ソーズは一盃口含みだが、345sの完成メンツを抜き出して形を見ると分かりやすい。35788s＋345s。',
    accept_tiles: {
    "七筒" => 15,
    "三索" => 12,
    "七索" => 11
...
仕掛け_quiz_data = [
  ...
  {
    tiles: %w[五筒 五筒 七筒 三萬 七萬 七萬 七索 七索 七索 九索 中 中 中],
    correct: '五筒',
    dora: '發',
    situation: '東1局 東家 5巡目',
    explanation: 'ドラ3持ってて、役が確定してる状態。5p6p7m8sは鳴いてくっつきの1シャンテンにとろう。7sをポンすることによって8sを引き出しやすくなる。8s鳴きは残った形が苦しいので鳴かない',
    call_options: %w[五筒 六筒 七萬 七索 八索 全てスルー],
    correct_calls: %w[五筒 六筒 七萬 七索]
  },
  {
    tiles: %w[五筒 五筒 七筒 三萬 七萬 七萬 七索 七索 七索 九索 中 中 中],
    correct: '五筒',
  ...
  {
    tiles: %w[二筒 二筒 四萬 四萬 四萬 五萬 五萬 六萬 七萬 八萬 中 中 中],
    correct: '五萬',
    dora: '發',
    situation: '東1局 東家 5巡目',
    explanation: 'ドラ3持ってて、役が確定してる状態。3679mはチー、4mはポンするとリャンメン以上の形になる。',
    call_options: %w[二筒 三萬 四萬 五萬 六萬 七萬 八萬 九萬 全てスルー],
    correct_calls: %w[三萬 四萬 六萬 七萬 九萬]
  },
...
手役意識_quiz_data = [
  ...
  {
    tiles: %w[三萬 四萬 六萬 六萬 六萬 七萬 赤五筒 六筒 七筒 八筒 九筒 二索 三索 四索],
    correct: '九筒',
    dora: '九索',
    situation: '東1局 西家 7巡目',
    explanation: '受け入れの広さだけ見れば七萬切りが有利だが、最悪の引きが六筒だと赤五筒切りリーチしか残らない。一方で九筒切りならタンヤオと赤五筒活用が確定し、受け入れ枚数の差を十分に補える。さらに五萬を引けば四面待ちに発展する。',
    accept_tiles: {
    "七萬" => 33,
    "九筒" => 21,
    }
  ...
  {
    tiles: %w[四萬 四萬 六萬 三筒 四筒 五筒 六筒 六筒 八筒 三索 四索 五索 九索 九索],
    correct: '九索',
    dora: '三索',
    situation: '東1局 西家 4巡目',
    explanation: 'この形のまま進めても役が付かない。ヘッドが3つあるので1つ削っても速度差は小さい。九索を落とせばタンヤオが見えて進めやすい。',
    accept_tiles: {}
  },
  {
    tiles: %w[四萬 五萬 七萬 七筒 三筒 四筒 五筒 七筒 七筒 二索 三索 四索 六索 七索],
    correct: '七筒',
    dora: '一筒',
    situation: '東1局 西家 7巡目',
    explanation: '七索をいったん切っておき、六索を引けば三面待ちに広がる。',
    accept_tiles: {
    "四萬" => 16,
    "七萬" => 16,
    "七筒" => 16
